...
'''
def openfileEnc():
	filename = tkFileDialog.askopenfilename(initialdir = "/home/virajmakwana",title = "Select file",filetypes = (("text files","*.txt"),("all files","*.*")))
	fileToEncrptyEntryUpdate(filename)

def opendirectoryEnc():
	directory = tkFileDialog.askdirectory(initialdir = "/home/virajmakwana",title = "Select directory")
